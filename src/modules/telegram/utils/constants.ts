export const TELEGRAM_BOT_TOKEN = '7942071036:AAFz_o_p2p2o-Gq-1C1YZMQSdODCHJiu2dY';
export const WEBHOOK_URL = 'https://telegram-shop-bot-production.up.railway.app/telegram/webhook';
